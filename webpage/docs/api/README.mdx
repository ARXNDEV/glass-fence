---
id: glass-fence-api
title: "Glass Fence API Reference"
description: "Glass Fence uses WebRTC and WebSocket besides REST API to provide real-time video streaming, interactive collaboration, and remote desktop functionality."
...
<Export
  url={"https://raw.githubusercontent.com/arxndev/glass-fence/refs/heads/master/server/openapi.yaml"}
  proxy={undefined}
>
...
<Heading
  ...
  children={"Glass Fence API Reference"}
>
</Heading>



Glass Fence uses WebRTC and WebSocket besides REST API to provide real-time video streaming, interactive collaboration, and remote desktop functionality.

### Core Technologies

- **Video Streaming over WebRTC**
  - Glass Fence leverages **WebRTC** for real-time, low-latency, high-quality video and audio streaming.
