...
- Scroll to chat on mobile ([#496](https://github.com/ARXNDEV/glass-fence/pull/496))
- Added mobile keyboard icon to open the keyboard on mobile devices ([#497](https://github.com/ARXNDEV/glass-fence/pull/497))

### Fixes {#master-fixes}
- Fixed various bugs related to the legacy client and migration.
- Fixed long standing issue [#279](https://github.com/ARXNDEV/glass-fence/pull/279) where Google Chrome GPU acceleration did not work with Nvidia GPUs, thanks to [@TobyColeman](https://github.com/TobyColeman), [@alexbakerdev](https://github.com/alexbakerdev) and [@samstefan](https://github.com/samstefan) from [@wearewildcards](https://github.com/wearewildcards).

### Misc {#master-misc}
- Added an https condition to the healthcheck ([#503](https://github.com/ARXNDEV/glass-fence/pull/503), by @Garrulousbrevity).
...
- The server name is now `github.com/ARXNDEV/glass-fence/server` and can be used as a library.
...
## [Glass Fence v2.9.0](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.9.0) {#v2.9.0}
...
- Fix buffer overflow in Gstreamer log function [#382](https://github.com/ARXNDEV/glass-fence/pull/382) (by @tt2468).
...
- Add glib main loop to capture manager [#383](https://github.com/ARXNDEV/glass-fence/pull/383) (by @tt2468).
- Sync clipboard only if in focus.

## [Glass Fence v2.8.0](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.8.0) {#v2.8.0}
...
## [Glass Fence v2.6](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.6) {#v2.6}

### Bugs {#v2.6-bugs}
- Fixed fullscreen incompatibility for Safari [#121](https://github.com/ARXNDEV/glass-fence/issues/121).
...
## [Glass Fence v2.5](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.5) {#v2.5}

### Bugs {#v2.5-bugs}
- Fix ungoogled-chromium auto build bug.
- Audio on iOS works now! Apparently only for 15+ though [#62](https://github.com/ARXNDEV/glass-fence/issues/62).
...
## [Glass Fence v2.4](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.4) {#v2.4}
...
## [Glass Fence v2.3](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.3) {#v2.3}
...
## [Glass Fence v2.2](https://github.com/ARXNDEV/glass-fence/releases/tag/v2.2) {#v2.2}
