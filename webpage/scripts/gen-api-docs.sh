...
# Create README.md
mv docs/api/glass-fence-api.info.mdx docs/api/README.mdx

# Replace all occurences of docs/api/glass-fence-api with docs/v3/api
find docs/api -type f -exec sed -i 's/docs\/api\/glass-fence-api/docs\/v3\/api/g' {} \;
