...
:::tip
For more applications, check out [m1k1o/neko-apps](https://github.com/ARXNDEV/glass-fence-apps).
:::

### Networking:
- If you want to use Glass Fence in **external** network, you can omit `NEKO_NAT1TO1`. It will automatically get your Public IP.
- If you want to use Glass Fence in **internal** network, set `NEKO_NAT1TO1` to your local IP address (e.g. `NEKO_NAT1TO1: 192.168.1.20`)-

Currently, it is not supported to supply multiple NAT addresses directly to neko  (see https://github.com/ARXNDEV/glass-fence/issues/47).
