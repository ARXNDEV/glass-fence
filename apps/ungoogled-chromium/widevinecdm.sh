...
VERSION=$(curl -s https://api.github.com/repos/arxndev/go-crx3/releases/latest | grep 'tag_name' | cut -d '"' -f4)
ARTIFACT="go-crx3_${VERSION#v}_linux_amd64.tar.gz"
URL="https://github.com/arxndev/go-crx3/releases/download/${VERSION}/${ARTIFACT}"
