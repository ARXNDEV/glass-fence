  ...
  <vue-context class="context" ref="context">
    <template slot-scope="child" v-if="child.data">
      ...
      <template v-if="admin && !child.data.member.admin">
        <li class="seperator" />
        <li>
          <span @click="kick(child.data.member)" style="color: var(--gf-danger)">{{ $t('context.kick') }}</span>
        </li>
        <li>
          <span @click="ban(child.data.member)" style="color: var(--gf-danger)">{{ $t('context.ban') }}</span>
        </li>
      </template>
    </template>
  </vue-context>
